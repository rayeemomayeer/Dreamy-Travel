  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h1 className="text-8xl font-serif text-pink-900">Explore The World For Yourself</h1>
    ...
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h5 className="text-8xl font-serif  text-yellow-500">Book your dream vacation now</h5>
    ...
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h5 className="text-8xl font-serif  text-yellow-900">Services From Our Hotels</h5>
