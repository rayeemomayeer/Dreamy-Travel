...
const Tours = () => {
  ...
  <div id="tours" className="bg-white">
    <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <h1 className="title-font sm:text-4xl text-3xl my-16 font-bold text-gray-900 text-center" style={{fontFamily: "Montserrat, sans-serif"}}>Book your dream vacation now</h1>
