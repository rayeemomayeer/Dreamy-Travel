  ...
  <div className="container px-5 py-24 mx-auto flex md:items-left lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-start order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">Travel</h2>
        <nav className="list-none mb-10">
          <li>
            <HashLink to="/home#tours" className="text-gray-400 hover:text-white">Tours</HashLink>
          </li>
          <li>
            <HashLink to="/home#destination" className="text-gray-400 hover:text-white">Destination</HashLink>
          </li>
          
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">Orders</h2>
        <nav className="list-none mb-10">
          <li>
            <HashLink to="/placeorder" className="text-gray-400 hover:text-white">My Orders</HashLink>
          </li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <HashLink to="/adminpanel" className="text-gray-400 hover:text-white">Admin Panel</HashLink>
          </li>
          <li>
            <HashLink to="/login" className="text-gray-400 hover:text-white">Login</HashLink>
          </li>
          <li>
            <HashLink to="/user/:userName" className="text-gray-400 hover:text-white">Account Details</HashLink>
          </li>
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2021 all rights —
        <HashLink href="https://twitter.com/knyttneve" className="text-gray-500 ml-1" rel="noopener noreferrer" target="_blank">Dreamy Travels</HashLink>
      </p>
